				    ...
				    "objectTypesConfiguration": {
				      ...
				      "detectKnife": false
						...
						""".formatted(
								dto.getName()
								, dto.getSource()
								,configEntity.getFaceDetectorConfig().getMinFaceSize().getSelectedValue()
								,configEntity.getFaceDetectorConfig().getMaxFaceSize().getSelectedValue()
								,configEntity.getFaceDetectorConfig().getMaxFaces().getSelectedValue()
								,configEntity.getFaceDetectorConfig().getConfidenceThreshold().getSelectedValue()
								,configEntity.getFaceDetectorResource().getSelectedValue()
								,configEntity.getSpoofDetectorResource().getSelectedValue()
								,configEntity.getSpoofDetectorConfig().getDistantLivenessScoreThreshold().getSelectedValue()
								,configEntity.getSpoofDetectorConfig().getNearbyLivenessScoreThreshold().getSelectedValue()
								,configEntity.getSpoofDetectorConfig().getDistantLivenessConditions()
								,configEntity.getSpoofDetectorConfig().getNearbyLivenessConditions()
								);
